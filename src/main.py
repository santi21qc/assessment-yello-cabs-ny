...
def main(event):
    ...
    query_to_execute = """SELECT vendor_id, passenger_count, dropoff_longitude, dropoff_latitude, pickup_datetime, dropoff_datetime FROM bigquery-public-data.new_york.tlc_yellow_trips_2016 limit 10000000"""
